abstract class AppStrings {
  ...
  //!Forgot password
  forgotPasswordPage = "Forgot Password", sendResetPasswordLink = "Send Reset Passwrod Link", verificationNow = "Verification Now", resendCode = "Resend Code", verifyAccount = "Verify Account", enter4DigitCodeWeHaveSentTo = "Enter 4 digit code we have sent to ", haventReceivedVerificationCode = "Haven’t received verification code?", enterYourRegisteredEmailBelowToReceivePasswordResetInstructions = "Enter your registered email below to receive password reset instructions.";
}
